...
try:
    requests.get("http://localhost:8085/gp/gpControl/execute?p1=gpStream&a1=proto_v2&c1=restart")
except requests.exceptions.RequestException as e:
    print(f"[ERROR] Could not connect to the GoPro simulator server. Is it running? Error: {e}")
    exit()

# Connect to the video stream URL
stream_url = 'http://localhost:8085/live/preview'
...
# Stop simulated GoPro stream
requests.get("http://localhost:8085/gp/gpControl/stream/stop")
